...
size_t xghostty_simd_decode_utf8_until_control_seq(const uint8_t* HWY_RESTRICT
                                                      input,
                                                  size_t count,
                                                  char32_t* output,
                                                  size_t* output_count) {
  return xghostty::DecodeUTF8UntilControlSeq(input, count, output, output_count);
}
