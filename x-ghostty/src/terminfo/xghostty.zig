...
/// XGhostty's terminfo entry.
pub const xghostty: Source = .{
    .names = &.{
        ...
        // features.
        // HACK: This is a hack on a hack...we use "xterm-xghostty" to prevent
    ...
    // verify that XGhostty does indeed support it and if not we can fix it.
    .capabilities = &.{
        ...
        // actually work with XGhostty. todo is to validate these!
