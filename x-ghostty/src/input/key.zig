...
/// The set of key codes that XGhostty is aware of. These represent
...
/// UTF-8 and are produced by the associated apprt. XGhostty core has
/// no mechanism to map input events to strings without the apprt.
///
/// IMPORTANT: Any changes here update include/ghostty.h xghostty_input_key_e
pub const Key = enum(c_int) {
    ...
    /// Converts a W3C key code to a XGhostty key enum value.
    ///
    ...
    /// Converts a XGhostty key enum value to a W3C key code.
