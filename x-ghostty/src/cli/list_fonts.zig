...
/// XGhostty. This uses the exact same font discovery mechanism XGhostty uses to
/// find fonts to use.
///
...
/// same priority order XGhostty would use to pick a font.
///
/// Flags:
///
...
///     is identical to the `font-family` set of XGhostty configuration values, so
