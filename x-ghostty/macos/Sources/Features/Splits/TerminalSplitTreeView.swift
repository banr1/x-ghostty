...
enum TerminalSplitOperation {
    ...
    struct Drop {
        ...
        let payload: XGhostty.SurfaceView

        /// The surface it was dragged onto
        let destination: XGhostty.SurfaceView
...
private struct TerminalSplitLeaf: View {
    ...
    private struct SplitDropDelegate: DropDelegate {
        ...
        let viewSize: CGSize
        let destinationSurface: XGhostty.SurfaceView
        let action: (TerminalSplitOperation) -> Void
        ...
        func performDrop(info: DropInfo) -> Bool {
            ...
            _ = provider.loadTransferable(type: XGhostty.SurfaceView.self) { [weak destinationSurface] result in
                switch result {
