...
class TerminalViewContainer: NSView {
    ...
    func ghosttyConfigDidChange(_ config: XGhostty.Config, preferredBackgroundColor: NSColor?) {
...
extension TerminalViewContainer {
    ...
    struct DerivedConfig: Equatable {
        ...
        init?(config: XGhostty.Config, preferredBackgroundColor: NSColor?, cornerRadius: CGFloat?) {
