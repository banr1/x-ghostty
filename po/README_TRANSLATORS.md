...
file called `com.mitchellh.xghostty.pot`. **Do not edit this file.** The
...
```console
$ msginit -i po/com.mitchellh.xghostty.pot -l X -o "po/X.po"
```
...
```diff
 ...
 /po/com.mitchellh.xghostty.pot @ghostty-org/localization
