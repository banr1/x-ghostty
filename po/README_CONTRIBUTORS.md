...
located under `po/com.mitchellh.xghostty.pot`. **This file must stay in sync with
...
into binary `.mo` files, stored under `share/locale/<LOCALE>/LC_MESSAGES/com.mitchellh.xghostty.mo`.
