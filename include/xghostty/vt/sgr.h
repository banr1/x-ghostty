...
#ifndef XGHOSTTY_VT_SGR_H
#define XGHOSTTY_VT_SGR_H
 ...
 * ## Basic Usage
 *
 * 1. Create a parser instance with xghostty_sgr_new()
 * 2. Set SGR parameters with xghostty_sgr_set_params()
 * 3. Iterate through attributes using xghostty_sgr_next()
 * 4. Free the parser with xghostty_sgr_free() when done
 *
 * ## Example
 *
...
typedef enum XGHOSTTY_ENUM_TYPED {
  XGHOSTTY_SGR_ATTR_UNSET = 0,
  XGHOSTTY_SGR_ATTR_UNKNOWN = 1,
  XGHOSTTY_SGR_ATTR_BOLD = 2,
  XGHOSTTY_SGR_ATTR_RESET_BOLD = 3,
  XGHOSTTY_SGR_ATTR_ITALIC = 4,
  XGHOSTTY_SGR_ATTR_RESET_ITALIC = 5,
  XGHOSTTY_SGR_ATTR_FAINT = 6,
  XGHOSTTY_SGR_ATTR_UNDERLINE = 7,
  XGHOSTTY_SGR_ATTR_UNDERLINE_COLOR = 8,
  XGHOSTTY_SGR_ATTR_UNDERLINE_COLOR_256 = 9,
  XGHOSTTY_SGR_ATTR_RESET_UNDERLINE_COLOR = 10,
  XGHOSTTY_SGR_ATTR_OVERLINE = 11,
  XGHOSTTY_SGR_ATTR_RESET_OVERLINE = 12,
  XGHOSTTY_SGR_ATTR_BLINK = 13,
  XGHOSTTY_SGR_ATTR_RESET_BLINK = 14,
  XGHOSTTY_SGR_ATTR_INVERSE = 15,
  XGHOSTTY_SGR_ATTR_RESET_INVERSE = 16,
  XGHOSTTY_SGR_ATTR_INVISIBLE = 17,
  XGHOSTTY_SGR_ATTR_RESET_INVISIBLE = 18,
  XGHOSTTY_SGR_ATTR_STRIKETHROUGH = 19,
  XGHOSTTY_SGR_ATTR_RESET_STRIKETHROUGH = 20,
  XGHOSTTY_SGR_ATTR_DIRECT_COLOR_FG = 21,
  XGHOSTTY_SGR_ATTR_DIRECT_COLOR_BG = 22,
  XGHOSTTY_SGR_ATTR_BG_8 = 23,
  XGHOSTTY_SGR_ATTR_FG_8 = 24,
  XGHOSTTY_SGR_ATTR_RESET_FG = 25,
  XGHOSTTY_SGR_ATTR_RESET_BG = 26,
  XGHOSTTY_SGR_ATTR_BRIGHT_BG_8 = 27,
  XGHOSTTY_SGR_ATTR_BRIGHT_FG_8 = 28,
 ...
 */
typedef enum XGHOSTTY_ENUM_TYPED {
  XGHOSTTY_SGR_UNDERLINE_NONE = 0,
  XGHOSTTY_SGR_UNDERLINE_SINGLE = 1,
  XGHOSTTY_SGR_UNDERLINE_DOUBLE = 2,
  XGHOSTTY_SGR_UNDERLINE_CURLY = 3,
 ...
 *
 * Attributes without associated data (e.g., XGHOSTTY_SGR_ATTR_BOLD) can be
 ...
 * allocator. The parser must be freed using xghostty_sgr_free() when
 * no longer needed.
 *
 ...
 * any attributes previously returned by xghostty_sgr_next().
 *
 ...
 * After calling this, xghostty_sgr_next() will start from the beginning
 ...
 * memory for an SGR attribute structure that can be passed to xghostty_sgr_next.
 *
 ...
 *
 * Frees memory allocated by xghostty_wasm_alloc_sgr_attribute.
 *
