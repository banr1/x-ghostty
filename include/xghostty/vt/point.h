...
#ifndef XGHOSTTY_VT_POINT_H
#define XGHOSTTY_VT_POINT_H
...
typedef enum XGHOSTTY_ENUM_TYPED {
  ...
  XGHOSTTY_POINT_TAG_ACTIVE = 0,

  /** Visible viewport (changes when scrolled). */
  XGHOSTTY_POINT_TAG_VIEWPORT = 1,

  /** Full screen including scrollback. */
  XGHOSTTY_POINT_TAG_SCREEN = 2,
