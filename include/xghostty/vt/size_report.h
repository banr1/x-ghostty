...
#ifndef XGHOSTTY_VT_SIZE_REPORT_H
#define XGHOSTTY_VT_SIZE_REPORT_H
 ...
 * ## Basic Usage
 *
 * Use xghostty_size_report_encode() to encode a size report into a
 * caller-provided buffer. If the buffer is too small, the function
 * returns XGHOSTTY_OUT_OF_SPACE and sets the required size in the
 * output parameter.
 *
 * ## Example
 *
...
#endif /* XGHOSTTY_VT_SIZE_REPORT_H */
