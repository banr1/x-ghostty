...
#ifndef XGHOSTTY_VT_FORMATTER_H
#define XGHOSTTY_VT_FORMATTER_H
 ...
 *
 * If the buffer is too small, returns XGHOSTTY_OUT_OF_SPACE and sets
 ...
 * xghostty_free(), passing the same allocator (or NULL for the default)
