...
#ifndef XGHOSTTY_VT_SYS_H
#define XGHOSTTY_VT_SYS_H
...
typedef enum XGHOSTTY_ENUM_TYPED {
    XGHOSTTY_SYS_LOG_LEVEL_ERROR = 0,
    XGHOSTTY_SYS_LOG_LEVEL_WARNING = 1,
 ...
 *
 * @param userdata    The userdata pointer set via XGHOSTTY_SYS_OPT_USERDATA
...
typedef enum XGHOSTTY_ENUM_TYPED {
     ...
     * discarded.
     *
     * Use xghostty_sys_log_stderr as a convenience callback that
 ...
 * Can be passed directly to xghostty_sys_set():
 *
 * @code
 * xghostty_sys_set(XGHOSTTY_SYS_OPT_LOG, &xghostty_sys_log_stderr);
 * @endcode
 */
