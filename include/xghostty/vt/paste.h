...
#ifndef XGHOSTTY_VT_PASTE_H
#define XGHOSTTY_VT_PASTE_H
 ...
 * ## Basic Usage
 *
 * Use xghostty_paste_is_safe() to check if paste data contains potentially
 * dangerous sequences before sending it to the terminal.
 *
 * Use xghostty_paste_encode() to encode paste data for writing to the pty,
 ...
 */
XGHOSTTY_API bool xghostty_paste_is_safe(const char* data, size_t len);
 ...
 * XGHOSTTY_OUT_OF_SPACE and sets the required size in @p out_written.
