...
#ifndef XGHOSTTY_VT_SCREEN_H
#define XGHOSTTY_VT_SCREEN_H
 ...
 * must be queried via xghostty_cell_get(). Obtain cell values from
 * terminal query APIs.
 *
 * @ingroup screen
 */
 ...
 * must be queried via xghostty_row_get(). Obtain row values from
 * terminal query APIs.
 *
 * @ingroup screen
 */
...
typedef enum XGHOSTTY_ENUM_TYPED {
  ...
  XGHOSTTY_CELL_CONTENT_CODEPOINT = 0,

  /** A codepoint that is part of a multi-codepoint grapheme cluster. */
  XGHOSTTY_CELL_CONTENT_CODEPOINT_GRAPHEME = 1,

  /** No text; background color from palette. */
  XGHOSTTY_CELL_CONTENT_BG_COLOR_PALETTE = 2,
...
typedef enum XGHOSTTY_ENUM_TYPED {
  ...
  XGHOSTTY_CELL_WIDE_NARROW = 0,

  /** Wide character, cell width 2. */
  XGHOSTTY_CELL_WIDE_WIDE = 1,

  /** Spacer after wide character. Do not render. */
  XGHOSTTY_CELL_WIDE_SPACER_TAIL = 2,
...
typedef enum XGHOSTTY_ENUM_TYPED {
  ...
  XGHOSTTY_CELL_SEMANTIC_OUTPUT = 0,

  /** Content that is part of user input. */
  XGHOSTTY_CELL_SEMANTIC_INPUT = 1,
 ...
 * using `xghostty_cell_get`.
 *
 * @ingroup screen
 */
typedef enum XGHOSTTY_ENUM_TYPED {
  /** Invalid data type. Never results in any data extraction. */
  XGHOSTTY_CELL_DATA_INVALID = 0,
   ...
   */
  XGHOSTTY_CELL_DATA_CODEPOINT = 1,
   ...
   * Output type: bool *
   */
  XGHOSTTY_CELL_DATA_HAS_STYLING = 5,
   ...
   * Output type: bool *
   */
  XGHOSTTY_CELL_DATA_HAS_HYPERLINK = 7,
   ...
   * Output type: bool *
   */
  XGHOSTTY_CELL_DATA_PROTECTED = 8,
...
typedef enum XGHOSTTY_ENUM_TYPED {
  ...
  XGHOSTTY_ROW_SEMANTIC_NONE = 0,

  /** Prompt cells exist and this is a primary prompt line. */
  XGHOSTTY_ROW_SEMANTIC_PROMPT = 1,
 ...
 * using `xghostty_row_get`.
 *
 * @ingroup screen
 */
typedef enum XGHOSTTY_ENUM_TYPED {
  /** Invalid data type. Never results in any data extraction. */
  XGHOSTTY_ROW_DATA_INVALID = 0,
   ...
   * Output type: bool *
   */
  XGHOSTTY_ROW_DATA_WRAP_CONTINUATION = 2,
   ...
   * Output type: bool *
   */
  XGHOSTTY_ROW_DATA_KITTY_VIRTUAL_PLACEHOLDER = 7,
