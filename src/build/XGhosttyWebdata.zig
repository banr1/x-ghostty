//! GhosttyWebdata generates all the XGhostty website data that is
...
pub fn init(
...

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_config_out,
            "share/xghostty/webdata/config.mdx",
        ).step);
    }

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_actions_out,
            "share/xghostty/webdata/actions.mdx",
        ).step);
    }

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_commands_out,
            "share/xghostty/webdata/commands.mdx",
        ).step);
    }
