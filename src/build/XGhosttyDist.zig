...
pub fn init(b: *std.Build, cfg: *const Config) !GhosttyDist {
    ...
    // embed the XGhostty version in the tarball
    {
    ...
    // This is the root XGhostty source dir of the extracted source tarball.
...
/// of the source tarball with XGhostty. These aren't committed to the Git
