...
pub const Action = enum {
    ...
    /// Wrap `ssh` to configure XGhostty terminal integration on remote hosts
    ssh,
    ...
    // Show which font face XGhostty loads a codepoint from.
    @"show-face",
    ...
    // Use IPC to tell the running XGhostty to open a new window.
    @"new-window",

    // Use IPC to tell the running XGhostty to toggle the quick terminal.
