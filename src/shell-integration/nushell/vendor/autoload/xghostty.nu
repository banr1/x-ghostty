...
export module ghostty {
  def has_feature [feature: string] {
    $feature in ($env.XGHOSTTY_SHELL_FEATURES | default "" | split row ',')
  }
...
if 'XGHOSTTY_SHELL_INTEGRATION_XDG_DIR' in $env {
  if 'XDG_DATA_DIRS' in $env {
    $env.XDG_DATA_DIRS = ($env.XDG_DATA_DIRS | str replace $"($env.XGHOSTTY_SHELL_INTEGRATION_XDG_DIR):" "")
  }
  hide-env XGHOSTTY_SHELL_INTEGRATION_XDG_DIR
}
