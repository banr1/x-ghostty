...
/// This is true if the app that XGhostty is in is focused. This may
...
/// XGhostty is initialized but a well behaved apprt should call
...
/// the focus state of the entire app containing XGhostty changes.
...
/// Call to notify XGhostty that the color scheme for the app has changed.
