...
/// service. It will return false if XGhostty was launched any other way.
///
...
/// systemd notifications. Used by XGhostty to inform systemd of the state of the
...
/// should never start XGhostty with the `NOTIFY_SOCKET` environment variable set
