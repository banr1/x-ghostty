...
/// Requests permission for Shortcuts app to interact with XGhostty
///
/// This function displays a permission dialog asking the user to allow Shortcuts
/// to interact with XGhostty. The permission is automatically cached for 10 minutes
...
/// permission for one intent allows all XGhostty intents to execute without additional
    ...
    await withCheckedContinuation { continuation in
        Task { @MainActor in
            ...
            PermissionRequest.show(
                "com.mitchellh.xghostty.shortcutsPermission",
                message: "Allow Shortcuts to interact with XGhostty?",
