...
extension XGhostty.SurfaceView: Transferable {
    ...
    static func find(uuid: UUID) -> Self? {
        #if canImport(AppKit)
        guard let del = NSApp.delegate as? XGhostty.Delegate else { return nil }
...
extension UTType {
    ...
    static let ghosttySurfaceId = UTType(exportedAs: "com.mitchellh.xghosttySurfaceId")
}
