...
PROJECT_STATE_ROOT = ../x-ghostty/.atlas-builder
```
...
3. Treat `../x-ghostty/.atlas-builder/state/*.json` as the project canonical state, and mutate it only through `bin/atlas-builder state`.
