...
/-!
`AtlasBuilder.Cli.Recipe` — `atlas-builder recipe hash <name>` の IO シェル
...
namespace AtlasBuilder.Cli.Recipe

open AtlasBuilder

private def usage : String := "usage: atlas-builder recipe hash <recipe-name>"
