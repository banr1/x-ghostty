...
/-!
`AtlasBuilder.Core.Text` — state エンジンのテキスト判定群。旧 Python 実装との
...
namespace AtlasBuilder.Core.Text

open AtlasBuilder.Core.Prim (dropLit? digitsToNat)
