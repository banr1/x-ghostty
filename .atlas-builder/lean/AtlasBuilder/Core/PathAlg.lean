/-!
`AtlasBuilder.Core.PathAlg` — 正規化済みセグメント列上のパス代数
...
namespace AtlasBuilder.Core.PathAlg
...
#guard childPath "/" "x" == "/x"
#guard childPath "/a" ".atlas-builder/state" == "/a/.atlas-builder/state"

end AtlasBuilder.Core.PathAlg
