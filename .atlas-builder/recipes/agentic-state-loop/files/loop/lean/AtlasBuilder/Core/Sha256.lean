...
/-!
`AtlasBuilder.Core.Sha256` — 純 Lean の SHA-256(FIPS 180-4。LEAN_MIGRATION_PLAN.md §4.4)。
...
を `#guard` でコンパイル時検査する(§4.6 B-T1 の土台)。
-/

namespace AtlasBuilder.Core.Sha256
