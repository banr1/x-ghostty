...
/-!
`Mercator.State.Model` — state 判定核の入力型と寛容デコードプリミティブ(純粋)。
...
namespace Mercator.State.Model
...
def placeholderMarker : String := "MERCATOR-TEMPLATE-PLACEHOLDER"
